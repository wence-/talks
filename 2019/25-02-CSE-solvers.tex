  ...
  \begin{columns}
    \begin{column}{0.4\textwidth}
      \begin{block}{Mesh}
        \begin{center}
          \begin{tikzpicture}
            \input{\jobname.figures/tet_simple.tex}
          \end{tikzpicture}
        \end{center}
      \end{block}
    \end{column}
    \begin{column}{0.6\textwidth}
      \begin{block}{Graph representation}
        \begin{center}
          \begin{onlyenv}<1>
            \begin{tikzpicture}
              \input{\jobname.figures/tet_graph.tex}
            \end{tikzpicture}
          \end{onlyenv}
          \begin{onlyenv}<2>
            \begin{tikzpicture}
...
\begin{frame}[fragile]
  ...
  \begin{block}{Vanka patch}
    ...
    \only<4-6>{Taylor-Hood: loop over vertices, gather closure of star}
    \nocite{Vanka:1986}
  \end{block}
  \begin{columns}
    \begin{column}{0.4\textwidth}
