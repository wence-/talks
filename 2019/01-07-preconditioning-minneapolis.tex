...
\begin{frame}
  ...
  \begin{exampleblock}{$H(\div)$ Riesz map}
  ...
  \begin{answer}{Problem is difficult even for moderate $\gamma$}
    \textcite{Arnold:2000}: use block Jacobi with blocks around vertices
    \begin{center}
      \begin{table}
        \centering
        \begin{tabular}{c|cccccc}
          ...
          Block Jacobi & 5 & 18 & 23 & 24 & 24 & 23
        \end{tabular}
        \caption{Preconditioned CG iterations for Raviart-Thomas
          elements}
      \end{table}
    \end{center}
  \end{answer}
...
\begin{frame}
  ...
  \begin{itemize}
  \item For symmetric problems, can use kernel decomposition ideas of
