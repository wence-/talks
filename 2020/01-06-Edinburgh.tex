...
\begin{frame}
  \begin{challenge}{}
    NWP multigrid work required a lot of hand-coding

    Motivated further work in being able to write
    \emph{preconditioner/solver} algorithms at a more abstract level.
  \end{challenge}

  \begin{answer}{}
    Focus for past few years, with application focus of incompressible
...
\begin{frame}
  ...
  \item To build a $\gamma$-robust scheme we need
    ...
    \item[$\Rightarrow$] overlapping Schwarz smoother with
      decomposition that decomposes the kernel.
    \end{itemize}
  \end{itemize}
\end{frame}
