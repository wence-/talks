...
\begin{frame}
  ...
  \begin{center}
    \begin{tikzpicture}
      \node (B) {\includegraphics[height=2cm]{bandedmatrix}};
      \node (C) [right=0.3cm of B,yshift=0.6cm] {\includegraphics[height=1.5cm]{columndofs}};
      \node (A) [below=0.1cm of C] {\includegraphics[height=1cm]{MeshHierarchy}};
      \end{tikzpicture}
    \end{center}
