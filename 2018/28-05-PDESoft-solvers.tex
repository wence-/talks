...
opts = {
  ...
  |\colourpetsc{”fieldsplit\_1”}|: {
     ...
     |\colourpetsc{”hat\_ksp\_type”: ”richardson”}|,
     "hat_ksp_max_it": 5,
     |\colourpetsc{”hat\_pc\_type”: ”hypre”}|
 }
...
\begin{frame}
  ...
  \begin{block}{Building blocks}
    \begin{itemize}
    \item Decomposition of mesh into patches\uncover<2->{:
        \alert{PETSc} with standard FEM adjacency for closure}
